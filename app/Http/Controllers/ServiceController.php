...
class ServiceController extends Controller
{
    ...
    {	
        ...
        $service->original_currency = $request->input('original_currency');
        $service->cost = convert_currency($request->input('original_currency'), base_currency(), $request->input('original_cost'));
        $service->original_cost = $request->input('original_cost');
