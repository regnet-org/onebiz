...
$('.dropify').dropify({
    messages: {
        'default': $lang_file_drag_drop_click,
        'replace': $lang_file_drag_drop_replace,
        'remove':  $lang_file_remove,
        'error':   $lang_file_ooops
    }
});
	...
	//Permission Screen
	$(document).on('change','#permissions #user_id',function(){
		showRole($(this));
	});
