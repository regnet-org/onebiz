        ...
        <div class="row justify-content-center pb-3">
            <div class="col-lg-6">
                <div class="section-title text-center pb-10">
                    <h4 class="title">{{ _lang('RegComert Form Title') }}</h4>
                    <p class="text">{{ _lang('RegComert Form Subtitle') }}</p>
                </div> <!-- section title -->
            </div>
        </div> <!-- row -->
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="contact-form">
                    <form id="contact-form" action="{{ url('regcomert/send_regcomert_message') }}" method="post" data-toggle="validator">
                        {{ csrf_field() }}
                        <input type="hidden" name="subject" value="{{ _lang('RegComert Form Message') }}">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="single-form form-group">
                                    <input type="text" name="name" value="{{ old('name') }}" placeholder="{{ _lang('RegComert Form Name') }}" data-error="Name is required." required="required">
                            ...
                            <div class="col-md-6">
                                <div class="single-form form-group">
                                    <input type="text" name="phone" value="{{ old('phone') }}" placeholder="{{ _lang('RegComert Form Phone') }}" data-error="Phone is required." required="required">
                                    <div class="help-block with-errors"></div>
                                </div> <!-- single form -->
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="single-form form-group">
                                    <textarea placeholder="{{ _lang('RegComert Form Message') }}" name="message" data-error="Please, leave us a message." required="required">{{ old('message') }}</textarea>
                                    <div class="help-block with-errors"></div>
                                </div> <!-- single form -->
                            </div>
