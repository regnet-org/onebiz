...
<div class="row">
	<div class="col-12">
		...
		<div class="card clearfix">
			...
			@php $base_currency = get_company_field( $invoice->company_id, 'base_currency', get_option('currency', 'USD') ); @endphp
						...
						<table class="table table-bordered" id="invoice-summary-table">
							<tbody>
									<tr>
										 ...
										 <td class="text-right">
											@if($client_currency != $base_currency)
												<span>{{ decimalPlace(convert_currency($base_currency, $client_currency, $invoice->tax_total), currency($client_currency)) }}</span>	
											@else
									...
									<tr>
										 ...
										 <td class="text-right">
											 @if($client_currency != $base_currency)
												<b>{{ decimalPlace($invoice->converted_total, currency($client_currency)) }}</b>
											@else
									...
									<tr>
										 ...
										 <td class="text-right">
											@if($client_currency != $base_currency)
												<span>{{ decimalPlace(convert_currency($base_currency, $client_currency, $invoice->paid), currency($client_currency)) }}</span>	
											@else
