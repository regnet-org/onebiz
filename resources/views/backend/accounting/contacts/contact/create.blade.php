			...
			<div class="card-body">
			   <div class="col-md-12">
				  <div class="form-group">
					...
					<input type="file" class="form-control dropify" name="contact_image"  data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG" data-max-file-size="1M"  data-max-width="300">
				  </div>
				</div>
			</div>
		</div>
