						...
						<div class="row">
							...
							<div class="col-md-6">
							  <div class="form-group">
								...
								<input type="text" class="form-control" name="vat_id" value="{{ $contact->vat_id }}" required>
							  </div>
							</div>
							...
							<div class="col-md-6">
							  <div class="form-group">
								...
								<input type="text" class="form-control" name="reg_no" value="{{ $contact->reg_no }}" required>
							  </div>
							</div>
							...
							<div class="col-md-6">
							  <div class="form-group">
								...
								<input type="text" class="form-control" name="iban" value="{{ $contact->iban }}">
							  </div>
							</div>
							...
							<div class="col-md-6">
							  <div class="form-group">
								...
								<input type="text" class="form-control" name="bank_name" value="{{ $contact->bank_name }}">
							  </div>
							</div>
					...
					<div class="card-body">
					   <div class="col-md-12">
						  <div class="form-group">
							...
							<input type="file" class="form-control dropify" name="contact_image" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG" data-max-file-size="1M"  data-max-width="300"  data-default-file="{{ $contact->contact_image != "" ? asset('public/uploads/contacts/'.$contact->contact_image) : '' }}" > 
