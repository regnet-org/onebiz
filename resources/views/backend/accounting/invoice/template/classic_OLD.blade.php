							 ...
							 <tbody id="invoice">
								 @foreach($invoice->invoice_items as $item)
									<tr id="product-{{ $item->item_id }}">
										...
										<td class="text-right">{{ $client_currency != $base_currency ? decimalPlace(convert_currency($base_currency, $client_currency, $item->discount), currency($client_currency)) : decimalPlace($item->unit_cost, $currency) }}</TD>
										<td class="no-print">{{ strtoupper($item->tax_method) }}</td>
										<td class="text-right">{{ $client_currency != $base_currency ? decimalPlace(convert_currency($base_currency, $client_currency, $item->tax_amount), currency($client_currency)) : decimalPlace($item->unit_cost, $currency) }}</TD>
										<td class="text-right">{{ $client_currency != $base_currency ? decimalPlace(convert_currency($base_currency, $client_currency, $item->sub_total), currency($client_currency)) : decimalPlace($item->unit_cost, $currency) }}</TD>
									</tr>
								 @endforeach
							 </tbody>
						</table>
