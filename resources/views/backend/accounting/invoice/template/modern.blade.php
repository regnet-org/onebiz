									 ...
									 <table class="classic-table">
										<tbody>
											 <tr>
												...
												<td class="text-right">
													<img src="{{ asset('public/images/modern-invoice-bg.png') }}" class="wp-300 d-none d-md-inline">
												</td>
											 </tr>
										</tbody>
									 </table>
							...
							<tbody>
								...
								@if($invoice->status != 'Paid')
									<tr>
										 ...
										 <td class="text-right">
											@if($client_currency != $base_currency)
											<span>{{ decimalPlace(convert_currency($base_currency, $client_currency, ($invoice->grand_total - $invoice->paid)), currency($client_currency)) }}</span><br>	
											@endif
