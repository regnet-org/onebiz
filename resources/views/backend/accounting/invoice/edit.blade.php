					...
					<div class="row">
									...
									<tbody>
										@foreach($invoice->invoice_items as $item)
											<tr id="product-{{ $item->item_id }}">
												...
												<td class="text-right tax-method">{{ strtoupper(__('general.'.$item->tax_method))  }}</td>
						...
						<div class="col-md-6">
							<div class="form-group">
							  ...
							  <input type="text" class="form-control" name="invoice_created_name" value="{{ $invoice->invoice_created_name }}">		
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
							  <label class="control-label">{{ _lang('Invoice Created CNP') }}</label>				
							  <input type="text" class="form-control" name="invoice_created_cnp" value="{{ $invoice->invoice_created_cnp }}">		
							</div>
						</div>
