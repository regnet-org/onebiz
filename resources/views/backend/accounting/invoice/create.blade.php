		...
		<div class="row">	
					...
					<table id="order-table" class="table table-bordered">
						<thead>
							<tr>
								...
								<th class="text-right">{{ _lang('Unit Cost') }} <span class="curr">{{ $currency  }}</span></th>
								<th class="text-right wp-100">{{ _lang('Discount') }} <span class="curr">{{ $currency  }}</span></th>
								<th class="text-right">{{ _lang('Tax method') }}</th>
								<th class="text-right">{{ _lang('Tax') }} <span class="curr">{{ $currency  }}</span></th>
								<th class="text-right">{{ _lang('Sub Total') }} <span class="curr">{{ $currency  }}</span></th>
			...
			<div class="col-md-6">
				<div class="form-group">
				  ...
				  <input type="text" class="form-control" name="invoice_created_name" value="{{ old('invoice_created_name') ?? get_company_option('invoice_created_name') }}">		
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
				  <label class="control-label">{{ _lang('Invoice Created CNP') }}</label>				
				  <input type="text" class="form-control" name="invoice_created_cnp" value="{{ old('invoice_created_cnp') ?? get_company_option('invoice_created_cnp') }}">		
				</div>
			</div>
			...
			<div class="col-md-12">
			  <div class="form-group">
				...
				<textarea class="form-control" rows="4" name="note">{{ old('note') ?? get_company_option('invoice_created_note') }}</textarea>
			  </div>
			</div>
