			...
			<div class="card-body">
				<form method="post" class="validate" autocomplete="off" action="{{action('ProductController@update', $id)}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">{{ _lang('Product SKU') }}</label>						
								<input type="text" class="form-control" name="sku" value="{{ $item->product->sku }}">
							</div>
						</div>
						...
						<div class="col-md-12">
						  <div class="form-group">
								...
								<select class="form-control select2" name="original_currency" id="original_currency" required>
									...
									{{ get_currency_list($item->product->original_currency) }}
								</select>
						  </div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">{{ _lang('Product Cost')}}</label>						
								<input type="text" class="form-control" name="original_product_cost" value="{{ $item->product->original_product_cost }}" required>
							</div>
						</div>

						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">{{ _lang('Product Price')}}</label>						
								<input type="text" class="form-control" name="original_product_price" value="{{ $item->product->original_product_price }}" required>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="product_cost" value="{{ $item->product->product_cost }}" required readonly="readonly">
						</div>
						</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="product_price" value="{{ $item->product->product_price }}" required readonly="readonly">
						</div>
						</div>
