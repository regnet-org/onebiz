						...
						<div class="row">
							...
							<div class="col-md-6">
							  <div class="form-group">
								...
								<input type="text" class="form-control" name="iban" value="{{ get_company_option('iban') }}">
							  </div>
							</div>
							<div class="col-md-6">
							  <div class="form-group">
								<label class="control-label">{{ _lang('Bank Name') }}</label>						
								<input type="text" class="form-control" name="bank_name" value="{{ get_company_option('bank_name') }}">
							  </div>
							</div>
							...
							<div class="col-md-12">
								<div class="text-center"><h5>{{ _lang('Invoice General Settings') }}</h5></div>
							</div>	

							<div class="col-md-12">
								<div class="font-weight-bold pt-2 pb-2">{{ _lang('Invoice Created By') }}</div>
							</div>

							<div class="col-md-6">
								<div class="form-group">
								  <label class="control-label">{{ _lang('Invoice Created Name') }}</label>				
								  <input type="text" class="form-control" name="invoice_created_name" value="{{ get_company_option('invoice_created_name') }}">		
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
								  <label class="control-label">{{ _lang('Invoice Created CNP') }}</label>				
								  <input type="text" class="form-control" name="invoice_created_cnp" value="{{ get_company_option('invoice_created_cnp') }}">		
								</div>
							</div>
							<div class="col-md-12">
							  <div class="form-group">
								<label class="control-label">{{ _lang('Note') }}</label>						
								<textarea class="form-control" name="invoice_created_note">{{ get_company_option('invoice_created_note') }}</textarea>
							  </div>
							</div>
				  ...
				  <div class="card-body">
					  ...
					  <form method="post" class="validate params-panel" autocomplete="off" action="{{ url('company/general_settings/update') }}" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-6">
							  <div class="form-group">
								<label class="control-label">{{ _lang('Trimite email de confirmare la incasare') }}</label>		
								<select class="form-control auto-select" name="confirm_store_payment" data-selected="{{ get_company_option('confirm_store_payment',"yes") }}" required="">
