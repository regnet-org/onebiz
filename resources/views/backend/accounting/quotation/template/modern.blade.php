			...
			<div class="card-body">
									 ...
									 <table class="classic-table">
										<tbody>
											 <tr>
												...
												<td class="text-right">
													<img src="{{ asset('public/images/modern-quotation-bg.png') }}" class="wp-300 d-none d-md-inline">
												</td>
											 </tr>
										</tbody>
									 </table>
				...
				@endif
					 ...
					 @if(get_company_option('quotation_footer')  != '')
						<div class="invoice-note">{!! clean(get_company_option('quotation_footer')) !!}</div>
					 @endif
					 <!--End Quotation Note-->
				</div>
			</div>
