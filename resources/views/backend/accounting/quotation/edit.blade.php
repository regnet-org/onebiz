					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
							  ...
							  <input type="text" class="form-control" name="invoice_created_name" value="{{ $quotation->invoice_created_name }}">		
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
							  <label class="control-label">{{ _lang('Invoice Created CNP') }}</label>				
							  <input type="text" class="form-control" name="invoice_created_cnp" value="{{ $quotation->invoice_created_cnp }}">		
							</div>
						</div>
