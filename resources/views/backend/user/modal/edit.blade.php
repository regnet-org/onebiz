	...
	<div class="row p-2">
		...
		<div class="col-md-6">
		  <div class="form-group">
			...
			<select class="form-control auto-select" data-selected="{{ $user->company->allow_upload_after_10 }}" id="allow_upload_after_10" name="allow_upload_after_10" required>
		...
		<div class="col-md-6">
		  <div class="form-group">
			...
			<select class="form-control auto-select" data-selected="{{ $user->company->allow_file_manager_delete }}" id="allow_file_manager_delete" name="allow_file_manager_delete" required>
				<option value="0">{{ _lang('No') }}</option>
				<option value="1">{{ _lang('Yes') }}</option>
			</select>
		  </div>
