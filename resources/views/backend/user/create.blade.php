						...
						<div class="col-md-6">	
							  ...
							  <div class="col-md-12">
								 <div class="form-group">
									...
									<input type="file" class="dropify" name="profile_picture" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG" data-max-file-size="1M"  data-max-width="300" data-default-file="">
								 </div>
							  </div>
						</div>
		            </div>			
