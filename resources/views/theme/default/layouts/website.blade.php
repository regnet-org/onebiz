...
})(window,document,'script','dataLayer','GTM-W2JQG9M');</script>
<!-- End Google Tag Manager -->
	...
	<!--====== Title ======-->
    <title>{{ get_option('website_title','ONEBIZ - 1 Singura Platforma pentru Afaceri') }}</title>
    ...
    <meta name="og:site_name" content="{{ get_option('website_title','ONEBIZ') }}"/>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-W2JQG9M"
...
<!-- End Google Tag Manager (noscript) -->
                                ...
                                @else 
                                    <ul class="navbar-nav m-auto">
                                        ...
                                        <li class="nav-item {{ Request::is('site/features') ? 'active' : '' }}">
                                            <a class="page-scroll" href="{{ url('site/features') }}">{{ _lang('AVANTAJE') }}</a>
                                        </li>
                                        <li class="nav-item {{ Request::is('site/pricing') ? 'active' : '' }}">
                                            <a class="page-scroll" href="{{ url('site/pricing') }}">{{ _lang('PRETURI') }}</a>
                                        </li>
                                        <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright text-center">
                            <p class="text">{!! clean(get_array_option('website_copyright','','2020 ONEBIZ')) !!}</p>
                        </div>
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/5af6ee785f7cdf4f053423ee/default';
    s1.charset='UTF-8';
