						...
						<div class="col-md-10 col-sm-10 clearfix">
							...
							<ul class="notification-area float-right">
	                            @if(Auth::user()->user_type != 'admin')
									{{--<li class="hideonmobile">Ai intrebari? 0741.804.804</li>--}}
					...
					<div class="row align-items-center py-3">
						<div class="col-sm-12">
							<div class="breadcrumbs-area clearfix">
								...
								{{-- @if (!request()->routeIs('file_manager.index')) --}}
								<ul class="breadcrumbs float-left">
									...
									@foreach(Request::segments() as $segment)
										...
										@if(! $loop->last)
											@if((request()->routeIs('file_manager.index') && $segment=="directory"))
											@else
											<li>
											...
											@endif
										@else
											@if (request()->routeIs('file_manager.index') && isset($fm_breadcumbs))
												@foreach($fm_breadcumbs as $fm_b)
												<li>
													<a href="{{ url('file_manager/directory/'.encrypt($fm_b['id'])).($fm_b['name']=="Modele acte" ? "?modele_acte=1" : "") }}">{{$fm_b['name']}}</a>
												</li>
												@endforeach
											@endif
											<li>
