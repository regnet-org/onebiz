...
$language["AVANTAJE"] = "ADVANTAGES";
$language["PRETURI"] = "PRICES";
...
$language["months"] = '"Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"';
$language["Drag and drop a file here or click"] = "Drag and drop a file here or click";
$language["Drag and drop or click to replace"] = "Drag and drop or click to replace";
$language["Ooops, something wrong happended"] = "Ooops, something wrong happended";
$language["Storno"] = "Storno";
$language["Invoice Marked as Storno"] = "Invoice Marked as Storno";
$language["Invoice Storno"] = "Storno Invoice";
$language["from date"] = "from date";
$language["The results could not be loaded"] = "The results could not be loaded";
$language["Searching"] = "Searching…";
$language["No results found"] = "No results found";
$language["Bank Account"] = "Bank Account";
$language["Bank Name"] = "Bank Name";
$language["Invoice Created By"] = "Invoice Created By";
$language["Invoice Created Name"] = "Name";
...
$language["Allow to delete files in FileManager"] = "Allow to delete files in FileManager";