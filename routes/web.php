...
Route::group(['middleware' => ['install']], function () {
	...
	Route::group(['middleware' => ['auth','verified']], function () {
		...
		Route::group(['middleware' => ['admin']], function () {
			...
			Route::group(['prefix'=>'recurring-payment'], function() {
				Route::resource('clients','RecurringPayment\ClientController');
		...
		Route::group(['middleware' => ['company']], function () {
			...
			Route::get("contacts/autocomplete",array('as'=>'contact-autocomplete','uses'=> 'ContactController@autocomplete'));
			...
			//Invoice Controller
			Route::get('invoices/create-step-one', 'InvoiceController@createStepOne')->name('invoices.create.step.one'); //bx added 2021-10-18
			Route::post('invoices/create-step-one', 'InvoiceController@postCreateStepOne')->name('invoices.create.step.one.post');
			Route::get('invoices/create-step-two', 'InvoiceController@createStepTwo')->name('invoices.create.step.two');
			Route::post('invoices/create-step-two', 'InvoiceController@postCreateStepTwo')->name('invoices.create.step.two.post');
			Route::get('invoices/create-step-three', 'InvoiceController@createStepThree')->name('invoices.create.step.three');
			Route::post('invoices/create-step-three', 'InvoiceController@postCreateStepThree')->name('invoices.create.step.three.post');
			...
			Route::get('invoices/storno/{id}','InvoiceController@storno')->name('invoices.storno');
			...
			Route::get('invoices/export','InvoiceController@export_view')->name('export-view');
			Route::post('invoices/export','InvoiceController@export')->name('export');
			...
			Route::get('quotations/export','QuotationController@export_view')->name('quotation-export-view');
			Route::post('quotations/export','QuotationController@export')->name('quotation-export');
			...
			Route::any('file_manager/search','FileManagerController@search')->name('file_manager.search');
			...
			//BT Settings
			// Route::get('bt_auth','BTSettingsController@index');
			// Route::get('bt_auth/settings','BTSettingsController@addSettings')->name('bt_auth.settings');
			// Route::get('bt_auth/delsettings','BTSettingsController@deleteSettings')->name('bt_auth.delsettings');
			// Route::get('bt_auth/acc','BTSettingsController@showAccount')->name('bt_auth.acc');
			// Route::get('bt_auth/tr','BTSettingsController@showTransactions')->name('bt_auth.tr');

			Route::view('contact', 'backend/contact');

			Route::post('regcomert/send_regcomert_message', 'WebsiteController@send_regcomert_message');
			Route::view('regcomert', 'backend/regcomert');

			//View Invoice & Quotation with login
			Route::get('client/view_invoice/{id}','ClientController@view_invoice')->name('invoice.view');
			Route::get('client/view_quotation/{id}','ClientController@view_quotation')->name('quotation.view');
		});
        ...
        Route::get('staff/leave-company','StaffController@staffLeaveCompany')->name('staffLeaveCompany');
...
Route::any('membership/netopia_ipn', 'MembershipController@netopia_ipn')->name('netopia.payment_ipn');
Route::get('membership/netopia','MembershipController@netopia')->name('netopia');

Route::group(['prefix'=>'recurring-payment/netopia'], function() {
	Route::any('/ipn', 'RecurringPayment\RacurringPaymentController@ipn')->name('recurringpayment.ipn');
	Route::get('/thankyou', 'RecurringPayment\RacurringPaymentController@thankYou')->name('recurringpayment.thankyou');
	Route::get('/cron', 'RecurringPayment\RacurringPaymentController@cron')->name('recurringpayment.cron');
	Route::get('/pay/{id}', 'RecurringPayment\RacurringPaymentController@payRecurring')->name('recurringpayment.pay.first');
	Route::any('/cancel/{id?}', 'RecurringPayment\RacurringPaymentController@cancelSubscription')->name('recurringpayment.cancel');
	Route::any('/confirm/{id}', 'RecurringPayment\RacurringPaymentController@confirm')->name('recurringpayment.confirm');
});

Route::get('cron/filemanager-no-upload-notification','CronJobsController@FilemanagerNoUploadNotification');
